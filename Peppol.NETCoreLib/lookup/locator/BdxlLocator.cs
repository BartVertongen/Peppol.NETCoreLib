...
namespace no.difi.vefa.peppol.lookup.locator
{
    ...
    public class BdxlLocator : AbstractLocator
	{
        ...
        private readonly string bdxl_prefix = "B-";//or nothing?
        //Hostname of the SML
		...
		public BdxlLocator(enMode mode= enMode.Test)
        {
        }
        ...
        //ORIGINAL LINE: @SuppressWarnings("unused") public BdxlLocator(String hostname)
		public BdxlLocator(string hostname) : this(hostname, "SHA-256")
		{
		}
		...
		public BdxlLocator(string hostname, string digestAlgorithm) : this("", hostname, digestAlgorithm)
		{
		}
		...
		public BdxlLocator(string prefix, string hostname, string digestAlgorithm = "SHA256")
		{
