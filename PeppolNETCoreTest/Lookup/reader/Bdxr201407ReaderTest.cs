...
namespace VertSoft.Peppol.Lookup.Reader
{
	public class Bdxr201407ReaderTest
	{
		...
		private IMetadataReader reader = new Bdxr201407Reader();
		...
		public virtual void serviceMetadata()
		{
            ...
            ServiceMetadata result = reader.ParseServiceMetadata(new FetcherResponse(fsXml, null)).Content;
            ...
            Debug.Assert(((Endpoint)result.getEndpoint(processIdentifier, TransportProfile.AS2_1_0)).Certificate.Subject.ToString() 
